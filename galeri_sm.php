                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue-grey darken-1">
                                        <div class="col m12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=gsm" class="judul"><i class="material-icons">image</i> Gallery </a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                        ...
                        if(mysqli_num_rows($query) > 0){
                            ...
                            echo '
                                <div class="col m12">
                                    <div class="card blue lighten-5">
                                        <div class="card-content notif">
                                            <span class="card-title lampiran"><center>There Is No Data To Display</center></span>
                                        </div>
                                    </div>
                                </div>';
                        } echo '
