        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['no_agenda'] == "" || $_REQUEST['no_surat'] == "" || $_REQUEST['asal_surat'] == "" || $_REQUEST['isi'] == ""
                ...
                if(!preg_match("/^[0-9]*$/", $no_agenda)){
                    $_SESSION['no_agenda'] = 'The ID code form must be filled with numbers!';
                    echo '<script language="javascript">window.history.back();</script>';
                } else {

                    if(!preg_match("/^[a-zA-Z0-9.\/ -]*$/", $no_surat)){
                        $_SESSION['no_surat'] = 'Form IP addresses can only contain numeric and point characters (.)';
                        echo '<script language="javascript">window.history.back();</script>';
                    } else {

                        if(!preg_match("/^[a-zA-Z0-9.,() \/ -]*$/", $asal_surat)){
                            $_SESSION['asal_surat'] = 'The factory location form may only contain letters, spaces, commas (,), minus (-), parentheses () and slashes (/)';
                            echo '<script language="javascript">window.history.back();</script>';
                        } else {

                            if(!preg_match("/^[a-zA-Z0-9.,_()%&@\/\r\n -]*$/", $isi)){
                                $_SESSION['isi'] = 'The Detail Form can only contain letters, numbers, spaces, periods (.), Commas (,), minus (-), slashes (), brackets (), underscore (_), and (&) percent (%) and at (@)';
                                echo '<script language="javascript">window.history.back();</script>';
                            } else {

                                if(!preg_match("/^[a-zA-Z0-9., ]*$/", $nkode)){
                                    $_SESSION['kode'] = 'The Classification type form can only contain letters, numbers, spaces, periods (.) And commas (,) characters';
                                    echo '<script language="javascript">window.history.back();</script>';
                                } else {
                                    ...
                                    if(!preg_match("/^[a-zA-Z0-9., -]*$/", $indeks)){
                                        ...
                                        if(!preg_match("/^[0-9.-]*$/", $tgl_surat)){
                                            $_SESSION['tgl_surat'] = 'The Letter Date Form can only contain numbers and minus (-)';
                                            echo '<script language="javascript">window.history.back();</script>';
                                        } else {

                                            if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $keterangan)){
                                                $_SESSION['keterangan'] = 'The description form may only contain letters, numbers, spaces, periods (.), Commas (,), minus (-), slashes (/), and brackets ()';
                                                echo '<script language="javascript">window.history.back();</script>';
                                            } else {
                                                ...
                                                if($result > 0){
                                                    $_SESSION['errDup'] = 'The IP number is already in use, use another one!';
                                                    echo '<script language="javascript">window.history.back();</script>';
                                                } else {
                                                    ...
                                                    if($file != ""){
                                                        ...
                                                        if(in_array($eks, $ekstensi) == true){
                                                            if($ukuran < 2500000){
                                                                ...
                                                                $_SESSION['errSize'] = 'The size of the uploaded file is too large!';
                                                                echo '<script language="javascript">window.history.back();</script>';
                                                            }
                                                        } else {
                                                            $_SESSION['errFormat'] = 'The allowed file format is only * .JPG, * .PNG, * .DOC, * .DOCX or * .PDF!';
                                                            echo '<script language="javascript">window.history.back();</script>';
                                                        }
                                                    } else {
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=tsm&act=add" class="judul"><i class="material-icons">mail</i> Add User</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="POST" action="?page=tsm&act=add" enctype="multipart/form-data">
                    ...
                    <!-- Row in form START -->
                    <div class="row">
						<div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Taken from the classification code reference data">
                            ...
                            <input id="no_agenda" type="number" class="validate" name="no_agenda" required>
                                ...
                                ?>
                            <label for="no_agenda">Code ID</label>
                        </div>
						
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Fill with numbers">
                        ...
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Enter the plant location">
                            ...
                            <input id="asal_surat" type="text" class="validate" name="asal_surat" required>
                                ...
                                ?>
                            <label for="asal_surat">Plant Location</label>
                        </div>
						
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Enter IP Number">
                            ...
                            <input id="no_surat" type="text" class="validate" name="no_surat" required>
                                ...
                                ?>
                            <label for="no_surat">IP</label>
                        </div>
						
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Date of issue">
                            ...
                            <input id="tgl_surat" type="text" name="tgl_surat" class="datepicker" required>
                                ...
                                ?>
                            <label for="tgl_surat">Issue Date </label>
                        </div>
						
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="detailed information about the issue">
                        ...
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="additional information and labels">
                        ...
                        <div class="input-field col s6">
                            <div class="file-field input-field tooltipped" data-position="top" data-tooltip="If there is no file / scan of the letter image, leave it blank">
                                <div class="btn light-green darken-1">
                                    <span>File</span>
                                    <input type="file" id="file" name="file">
                                </div>
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" placeholder="Upload file / scan image">
                                        <?php
                                        ...
                                        ?>
                                    <small class="red-text">*File format allowed * .JPG, * .PNG, * .DOC, * .DOCX, * .PDF and maximum file size of 2MB!</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col 6">
                            <a href="?page=tsm" class="btn-large deep-orange waves-effect waves-light">CANCEL<i class="material-icons">clear</i></a>
                        </div>
                    </div>
