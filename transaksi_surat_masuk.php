                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="" class="judul"><i class="material-icons">mail</i> Monitoring Systems</a></li> <li class="waves-effect waves-light"><a href="?page=tsm&act=add"><i class="material-icons md-24">add_circle</i> Add New Data</a></li>
                                        </ul>
                                    </div>
                            ...
                            <table class="bordered" id="tbl">
                                <thead class="blue lighten-4" id="head">
                                    <tr>
										...
										<th width="10%">Type</th>
                                        <th width="30%">Information<br/> File</th>
                                        <th width="10%">Plant Name</th>
                                        <th width="11%">IP<br/>Tanggal</th>
                                        <th width="11%">Action <span class="right tooltipped" data-position="left" data-tooltip="Set the amount of data will be displayed"><a class="modal-trigger" href="#modal"><i class="material-icons" style="color: #333;">settings</i></a></span></th>

                                            <div id="modal" class="modal">
                                                <div class="modal-content white">
                                                    <h5>Amount of data will show per page</h5>';
                                                        ...
                                                        <form method="post" action="">
                                                            <div class="input-field col s12">
                                                                ...
                                                                <div class="modal-footer white">
                                                                    <button type="submit" class="modal-action waves-effect waves-green btn-flat" name="simpan">Save</button>';
                                ...
                                echo '<tr><td colspan="5"><center><p class="add">There is no data to be show. </p></center></td></tr>';
                            }
                          echo '</table>
                        </div>
                    </div>
