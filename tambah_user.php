                            ...
                            if(!preg_match("/^[2-3]*$/", $admin)){
                                ...
                                if($result > 0){
                                    ...
                                    if(strlen($username) < 5){
                                        $_SESSION['errUser5'] = 'Minimum of 5 Characters For Username';
                                        echo '<script language="javascript">window.history.back();</script>';
                                    } else {

                                        if(strlen($password) < 5){
                                            $_SESSION['errPassword'] = 'Minimum 5 Caracters Password!';
                                            echo '<script language="javascript">window.history.back();</script>';
                                        } else {
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=sett&sub=usr&act=add" class="judul"><i class="material-icons">person_add</i> Add User</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="post" action="?page=sett&sub=usr&act=add">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Enter your employee number">
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">supervisor_account</i><label>Select User Type</label><br/>
                    ...
                    <div class="row">
                        ...
                        <div class="col 6">
                            <a href="?page=sett&sub=usr" class="btn-large deep-orange waves-effect waves-light">Cancel <i class="material-icons">clear</i></a>
                        </div>
                    </div>
