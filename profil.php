            ...
            if(isset($_REQUEST['submit'])){
                ...
                <div class="row jarak-form">
                    ...
                    <form class="col s12" method="post" action="?page=pro&sub=pass">
                        ...
                        <!-- Row in form START -->
                        <div class="row">
                            <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Username at least 5 characters [letters, numbers or underscore (_)]">
                            ...
                            <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Enter your old password">
                                ...
                                <label for="password_lama">Your Old Password</label>
                            </div>
                            <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="input your employee number">
                                ...
                                <input id="nip" type="text" class="validate" name="nip" value="<?php echo $_SESSION['nip']; ?>" required autocomplete="off">
                                    ...
                                    ?>
                                <label for="nip">Employee Number</label>
                            </div>
                            <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Password is at least 5 characters long">
                                ...
                                <small class="red-text">* After pressing the "Save" button, you will be asked to re-login.</small>
                            </div>
                        </div>
                        <!-- Row in form END -->
                        <br/>
                        <div class="row">
                            ...
                            <div class="col 6">
                                <a href="?page=pro" class="btn-large deep-orange waves-effect waves-light">Cancel <i class="material-icons">clear</i></a>
                            </div>
                        </div>
...
?>
            ...
            <div class="row">
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">person</i> User Profile</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="post" action="save.php">
                    ...
                    <div class="row">
                        <div class="col m12">
                            <a href="?page=pro&sub=pass" class="btn-large blue waves-effect waves-light">Edit Your Profile<i class="material-icons">mode_edit</i></a>
                        </div>
                    </div>
