...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2019 at 06:34 AM
...
(1, 'Posco ICT', 'Posco ICT Indonesia', '', 'Jalan Afrika No.2 Kawasan Industri Krakatau, 42443, Samangraya, Citangkil, Kota Cilegon, Banten 42443', '', '', 'poscoictindonesia.co.id/', 'hrd_ict@posco.net', 'logo.png', 1);
...
(52, '001', 'Conficker', 'Computer Worm', 1),
(53, '002', 'ILOVEYOU', 'Computer Worm', 1),
(54, '003', 'Code Red', 'Computer Worm', 1),
(55, '004', 'Melissa', 'Macro Virus', 1),
(56, '005', 'Sasser', 'Computer Worm', 1),
(57, '006', 'Zeus', 'Malware\r\n', 1),
(58, '007', 'Stuxnet ', 'Malicious Computer Worm', 1),
(59, '008', 'Mydoom ', 'Computer Worm', 1),
(60, '009', 'CrypoLocker ', 'Ransomware', 1),
(61, '010', 'Flashback ', 'Trojan\r\n', 1);
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'administrator', '111594', 1),
(6, 'user1', '24c9e15e52afc47c225b757e7bee1f9d', 'useras', '88128', 3);
...
--
ALTER TABLE `tbl_klasifikasi`
  MODIFY `id_klasifikasi` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
