                ...
                echo '
                    ...
                    <div class="row agenda">
                        <div class="col s10">
                            ...
                            <p class="warna agenda">entry agenda from date <strong>'.$d." ".$nm." ".$y.'</strong> until date <strong>'.$d2." ".$nm2." ".$y2.'</strong></p>
                        </div>
                        <div class="col s2">
                        ...
                        <table class="bordered" id="tbl" width="100%">
                            <thead class="blue lighten-4">
                                <tr>
                                    ...
                                    <th width="11%">Plant Location</th>
                                    <th width="10%">IP</th>
                                    <th width="10%">Issue<br/>Date</th>
                            ...
                            if(mysqli_num_rows($query) > 0){
                                ...
                                echo '<tr><td colspan="9"><center><p class="add">There is no data to be show.</p></center></td></tr>';
                            } echo '
                        </table>
                    </div>';
            }
            ...
            echo '
                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col 12">
                                        <ul class="left">
                                            <li class="waves-effect waves-light"><a href="?page=ask" class="judul"><i class="material-icons">print</i> Print All Agenda<a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
                ...
                <div class="row jarak-form black-text">
                    <form class="col s12" method="post" action="">
                        ...
                        <div class="col s6">
                            <button type="submit" name="submit" class="btn-large blue waves-effect waves-light"> SHOW <i class="material-icons">visibility</i></button>
                        </div>
                    </form>
                </div>
                <!-- Row form END -->';
